...
<style>
input{width:300px; height:35px;border:1px solid black; border-radius: 10px;padding:2px; }

select{width:300px; height:35px; border:1px solid black; border-radius:5px;}
</style>
